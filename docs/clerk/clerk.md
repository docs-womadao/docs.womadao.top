...
| 开始游戏 | 游戏开始 | 游戏名 | 所有人 | 在当前子频道启动一个玩家队列 | `@店员` 开始游戏 真心话大冒险 | [点击查看具体用法](#游戏玩家队列系统) |
| 结束游戏 | 游戏结束 | - | 所有人 | 在当前子频道结束一个玩家队列 | `@店员` 结束游戏 | [点击查看具体用法](#游戏玩家队列系统) |
